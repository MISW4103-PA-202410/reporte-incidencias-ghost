...
Scenario: Como usuario me registro y creo un nuevo tag
  ...
  And I click in the tags menu button v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "1"
  And I click in the new tag button v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "2"
  And I fill the tag name "<TAG_NAME>" v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "3"
  And I click the save tag button v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "4"
  And I wait for 1 seconds
  And I click in the tags menu button v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "5"
  And I wait for 1 seconds
  And I verify the tag name created is "<TAG_NAME>" v and take a screenshot for version "v3.42" feature "crear-tag" scenario "1" step "6"
